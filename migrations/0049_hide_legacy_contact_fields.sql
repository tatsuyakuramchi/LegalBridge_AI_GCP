-- 0049_hide_legacy_contact_fields.sql
-- 通知先への集約に伴い、旧連絡先入力欄(当事者欄の担当・電話・メール)を非表示化。
--   - templates_config.json から該当 var を削除(フォーム非表示) -> field_schema 更新
--   - pub_master_corporate は署名欄に残っていた担当者参照も除去(HTML更新)
