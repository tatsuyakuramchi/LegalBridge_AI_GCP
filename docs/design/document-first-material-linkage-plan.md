...
- 版: **v0.1（ドラフト）** — 2026-06 壁打ち反映。実装着手前の方針確定メモ。
...
### 決定2：素材の帰属先 → **原作(source work)配下に一元化**（推奨・要最終承認）
...
- ⚠️ トレードオフあり（純粋な自社オリジナル作品で“原作が無い”ケースの扱い）。**ここだけ最終承認をもらってから実装**。
...
- **決定2の最終承認**（素材帰属を原作一元化でよいか。純自社オリジナルで原作不在のケースの扱い）。
