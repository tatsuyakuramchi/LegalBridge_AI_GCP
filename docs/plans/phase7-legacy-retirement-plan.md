...
| G3a | `contract_capabilities` 読取り 165 を `documents` 直読みへ(1:1 passthrough のため原則リネーム) | 第2弾〜(ファイル単位) | **進行中**: 第2弾リーフ8(16)→266、第3弾 unifiedIssues/formReadRoutes/db.ts(19)→247。ratchet 247。残: server.ts(52)/workModel(23)/dataLinkage(22)/sharedReads/contractsV2/contractCheckService(SELECT *系)/formReadRoutes 453 |
