...
// [移行済] RoyaltyPreviewPanel は schemas/royaltyStatement.tsx へ移設。
...
// [移行済] FinancialConditionPicker は schemas/royaltyStatement.tsx へ移設。
...
import { Database, Building2, User, ShieldCheck, Scale, AlertCircle, GitBranch, Briefcase, List, Coins, FileText, Settings } from 'lucide-react';
        ...
        <details className="group rounded-sm border border-input">
          ...
          <div className="p-4 border-t border-input space-y-3">
            {/* Phase 26: 基本契約の紐づけは「0. 業務委託基本契約を選ぶ」の
                UnifiedContractPicker に一本化。ここでの重複検索・手入力欄
                (HAS_BASE_CONTRACT / MASTER_CONTRACT_REF) は撤去/hidden 化した。 */}
