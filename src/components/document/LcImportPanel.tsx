...
export const LcImportPanel: React.FC<Props> = ({ existingCodes, onImport }) => {
  ...
  return (
    <div className="col-span-full mt-3 rounded-md border border-violet-200 bg-violet-50/40 px-3 py-3 space-y-2">
      <div className="flex items-center justify-between gap-2">
        <span className="flex items-center gap-1.5 text-[10px] font-mono font-bold uppercase tracking-[0.12em] text-violet-700">
      ...
      {error && (
        <div className="text-[10px] font-mono text-red-600 py-1">取得に失敗しました: {error}</div>
      )}
      ...
      {!loading && candidates && candidates.length > 0 && (
        <div className="space-y-1.5">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-[9px] font-mono text-violet-800/70 truncate">
                      {summarize(c)}
                    </div>
                  </div>
                </li>
          ...
          <button
            ...
            className="w-full text-[11px] font-mono px-2 py-1.5 rounded border border-violet-400 text-violet-700 hover:bg-violet-100 disabled:opacity-50 inline-flex items-center justify-center gap-1.5"
          >
            {importing ? (
              <>
