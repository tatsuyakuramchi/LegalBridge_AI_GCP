...
export async function initDb() {
  const tables = [
    ...
    `ALTER TABLE contract_capabilities ADD COLUMN IF NOT EXISTS record_type VARCHAR(50);`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_contract_capabilities_vendor_id ON contract_capabilities(vendor_id);`,
    `CREATE INDEX IF NOT EXISTS idx_contract_capabilities_contract_category ON contract_capabilities(contract_category);`,
    `CREATE INDEX IF NOT EXISTS idx_contract_capabilities_contract_type ON contract_capabilities(contract_type);`,
    `CREATE INDEX IF NOT EXISTS idx_contract_capabilities_record_type ON contract_capabilities(record_type);`,
    `CREATE INDEX IF NOT EXISTS idx_contract_capabilities_purpose_codes ON contract_capabilities USING GIN(purpose_codes);`,
