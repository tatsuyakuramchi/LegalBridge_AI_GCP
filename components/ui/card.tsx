...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-md bg-card py-4 text-sm text-card-foreground border border-border shadow-xs",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-sm leading-snug font-bold uppercase tracking-[0.12em] group-data-[size=sm]/card:text-xs",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-md border-t border-border bg-muted/40 p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
